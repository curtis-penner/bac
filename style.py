...
def set_style_pars(strictness):
    """
    Set the parameters f0p, f1p according to strictness and using
    y = 1 - strictness, y*y makes the scale a bit more intuitive ..
    ...
    log.info("Set style parameters, strictness %.2f (f0p=%.3f, f0x=%.3f)" %
             strictness, f0p, f0x)
